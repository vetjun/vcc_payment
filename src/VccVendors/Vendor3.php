...
class Vendor3 implements VendorInterface
{
    ...
    protected $currency;
    protected $em;
    protected $url = "http://www.mocky.io/v2/5da5dcd2340000221a632d50";
    /**
     * Vendor3 constructor.
     */
    ...
    private function store($api_result){
        ...
        $vcc_vendor->setCardNumber($api_result->number);
        $vcc_vendor->setReference($api_result->refCode);
        $vcc_vendor->setCvc($api_result->securityCode);
